...
Актуальная политика находится в [PRIVACY_POLICY.md](PRIVACY_POLICY.md) и отображается во frontend. В ней указаны оператор, контакты, подрядчики, сроки хранения и порядок удаления данных; перед существенным изменением обработки документ следует повторно проверить у профильного юриста.
